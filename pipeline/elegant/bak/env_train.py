...
class StockTradingEnvTrain:
    ...
    def load_stock_trading_data(start_date='2008-03-19', start_eval_date='2016-01-01', env_eval_date='2021-01-01'):
        ...
        processed_data_path = f'{cwd}/prp_data.csv'  # preprocessed data
        ...
        ticker_list = ['sh.600036', 'sh.600655', 'sz.002027', 'sh.601988', 'sh.002024', 'sh.002555']
...
#     if_eval = True  # False
#
#     env = StockTradingEnvTrain(if_eval=if_eval)
